class OJCarousel {
	...
	initProperties() {
		this.slideCache = {}; // Don't have to use selectors any time carousel need its slide
		this.timers = {
			slide: undefined,
			auto: undefined
		};
		this.isSwitchable = true; // Can user switch slide with arrows at the moment
		this.isDragging = false; // Is user dragging slide at the moment
		this.originalX = 0; // Cursor X when dragging started
		this.width = 0; // Slide container's width
	}
